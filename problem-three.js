...
function gatherSupplies(suppliesToLookFor){
    for(let numOfCurrentSupply = 0; numOfCurrentSupply < suppliesToLookFor.length; numOfCurrentSupply++){
        console.log("Jarvis has found some " + suppliesToLookFor[numOfCurrentSupply])
    }
   return suppliesToLookFor.length
}

console.log(gatherSupplies(["Noodles", "Cereal", "Drinks"]))