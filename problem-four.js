...
function raiderAvoidancePlan(targetsFoundWhileForaging){
    for(let numOfTargetsFound = 0; numOfTargetsFound < targetsFoundWhileForaging.length; numOfTargetsFound++) {
        let currentTarget = targetsFoundWhileForaging[numOfTargetsFound];


        if (currentTarget === "Raider" || currentTarget === "Zombie") {
...
console.log(raiderAvoidancePlan(["Food", "Shoes", "Plants","Zombie", "Raider", "Water"]))