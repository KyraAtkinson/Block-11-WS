...
function buildFenceCommand (numOfFencePosts, fencePostMaterial){
    for(let numOfCurrentPosts = 0; numOfCurrentPosts <= numOfFencePosts; numOfCurrentPosts++){
        console.log ("JARVIS is now building " + fencePostMaterial + " fence post number " + numOfCurrentPosts + ".")
    }  
}

buildFenceCommand(15,"stone")